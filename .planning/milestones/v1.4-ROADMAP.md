...
- [x] **Phase 9: Quick Look Preview** - Wire spacebar and context menu to open the native floating QLPreviewPanel for the selected image (completed 2026-03-16)
...
**Plans:** 1/1 plans complete
Plans:
- [x] 09-01-PLAN.md — Wire QLPreviewPanel with spacebar toggle, selection following, universal dismiss, and context menu integration
